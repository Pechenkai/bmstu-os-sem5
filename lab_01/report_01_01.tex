...
020A:0756  FF 06 006C        inc  word ptr ds:[6Ch]  ; (0040:006C=8367h)
020A:075A  75 04        jnz  loc_1      ; Jump if not zero
020A:075C  FF 06 006E        inc  word ptr ds:[6Eh]  ; (0040:006E=4)
...
020A:0760      loc_1:
020A:0760  83 3E 006E 18      cmp  word ptr ds:[6Eh],18h  ; (0040:006E=4)
020A:0765  75 15        jne  loc_2      ; Jump if not equal
020A:0767  81 3E 006C 00B0      cmp  word ptr ds:[6Ch],0B0h  ; (0040:006C=8367h)
020A:076D  75 0D        jne  loc_2      ; Jump if not equal
020A:076F  A3 006E        mov  word ptr ds:[6Eh],ax  ; (0040:006E=4)
020A:0772  A3 006C        mov  word ptr ds:[6Ch],ax  ; (0040:006C=8367h)
...
020A:077D  FE 0E 0040        dec  byte ptr ds:[40h]  ; (0040:0040=4)
...
020A:07AE  1F          pop  ds
020A:07AF  07          pop  es
020A:07B0  E9 FE99        jmp  $-164h  ; Iret 
; ...
...
020A:07C0  9F          lahf        ; Load ah from flags		                    ; Load ah from flags
...
\begin{center}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{graph1.png}
\end{center}

\begin{center}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{graph2.png}
\end{center}

\begin{center}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{graph3.png}
\end{center}
...
\begin{center}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{graph4.png}
\end{center}
